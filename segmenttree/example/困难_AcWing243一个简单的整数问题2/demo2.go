...
//	)
//	seg.WithOptimization(func(left int, right int, value interface{}) interface{} {
//		if left > right {
//			left, right = right, left
//		}
//		fmt.Println("select Optimization")
//		return (right - left + 1) * ToInt(value)
//	})
//	for i := 0; i < q; i++ {
//		var (
...
//}
//
//// WithOptimization 指定Optimization
